<img width="1024" height="1024" alt="svgrid" src="https://github.com/user-attachments/assets/1f73d06a-e4de-4bd5-991e-c466b22cb02d" />Svgrid

A high-performance, enterprise-ready Data Grid for Svelte

Svgrid is a modern data grid engine built specifically for Svelte applications.
It is designed to handle large-scale datasets, complex interactions, and extensible UI systems while staying reactive, fast, and lightweight.

Built with inspiration from enterprise-grade grids like AG Grid — but redesigned for the Svelte reactivity model.
...
Virtualization and rendering optimization are built into the core — not added later.
...
Svelte-native performance + simplicity + extensibility
